...
**Java-CSG** on [stackoverflow](http://stackoverflow.com/search?q=Java-CSG).

![](/resources/screenshot2.png)

To see what's possible with Java-CSG try [JFXScad](https://github.com/miho/JFXScad).

![](https://raw.githubusercontent.com/miho/JFXScad/master/resources/img/screenshot-02.png)

## How to Build Java-CSG
...
Open the `Java-CSG` [Gradle](http://www.gradle.org/) project in your favourite IDE (tested with NetBeans 7.4) and build it
by calling the `assemble` task.

### Command Line

Navigate to the [Gradle](http://www.gradle.org/) project (e.g., `path/to/Java-CSG`) and enter the following command
